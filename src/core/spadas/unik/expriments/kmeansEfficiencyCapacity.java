...
package core.spadas.unik.expriments;

import java.io.IOException;

import tree.trajectory.clustering.kmeans.kmeansAlgorithm;
import core.wlu.cs.levy.cg.KeyDuplicateException;
import core.wlu.cs.levy.cg.KeySizeException;

public class kmeansEfficiencyCapacity {

	public kmeansEfficiencyCapacity() {
	...
	public static void main(String[] args) throws IOException, KeySizeException, KeyDuplicateException {
		...
		int[] capacities = new int[] {10, 20, 40, 50, 60};//capacity
	...
	//	capacities = new int[] {30};
		...
		runkmeans.setrunIndexMethodOnly();// do not test the methods that do not use index
		runkmeans.setTestBallTree();
